...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1. Setting the description fo the post
        // 2. A button to launch the camera to take a picture
        // 3. A button to show the picture the user has taken
        // 4. A button to save and send the post to my Parse server

        findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            // Send post to server without an image
            // Grab the description they have inputted
    ...
    // Send a post object to my Parse server
